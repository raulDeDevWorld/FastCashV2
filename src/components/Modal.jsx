        ...
        <div  className="h-screen w-screen flex justify-center items-center bg-[#000000c2] fixed top-0 left-0  z-50  p-4 overflow-x-hidden overflow-y-auto md:inset-0">
            <div className="relative w-full max-w-md max-h-full">
                <div className="relative bg-white rounded-lg shadow ">
                    {successText !== 'Soporte' && <button type="button" className="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-[14px] w-8 h-8 ml-auto inline-flex justify-center items-center  dark:hover:text-white" onClick={()=>setModal('')}>
                    ...
                    <div className="p-6 text-center">
                       ...
                       {!alert && <> <button type="button" className="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-[14px] font-medium px-5 py-4 hover:text-gray-900 focus:z-10 mr-2  dark:text-gray-300 dark:border-gray-500 dark:hover:text-white  dark:focus:ring-gray-600" onClick={()=>setModal('')}>{cancelText ? cancelText : 'Cancelar'}</button>
