    ...
    switch (theme) {
        ...
        case 'Success':
            return <button
                ...
                className="text-white border-[1px] border-green-500 bg-green-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-[14px] w-full min-w-[180px]  sm:max-w-[380px] px-5 py-3 text-center"
            ...
            case 'Danger':
                return <button
                    type={type? type: "submit"}
                    className="text-white bg-[red] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-[14px]  min-w-[180px] w-full sm:max-w-[380px]  px-5 py-3 text-center"
