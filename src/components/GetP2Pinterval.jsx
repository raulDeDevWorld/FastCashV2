...
function StopWatch() {
  ...
  const [count, setCount] = useState(0);
    ...
    const {setTime_stamp, user, userDB, setUserProfile, modal, setModal, users, setUsers, setUserSuccess, success, setUserData, postsIMG, setUserPostsIMG, divisas, setDivisas, item, setItem, exchange, setExchange, } = useAppContext()
